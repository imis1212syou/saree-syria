...
(function(){
  ...
  async function saveStore(id){
    ...
    const payload={name,city:$('sa_city').value.trim()||null,area:$('sa_area').value.trim()||null,address:$('sa_address').value.trim()||null,phone:$('sa_phone').value.trim()||null,whatsapp_url:$('sa_whatsapp').value.trim()||null,opening_hours:$('sa_hours').value.trim()||null,working_days:$('sa_days').value.trim()||null,image_url,verified:!!$('sa_verified').checked,active:!!$('sa_active').checked,company_id:companyId,company_name:companyId?companyName:($('sa_company_name').value.trim()||null)};
